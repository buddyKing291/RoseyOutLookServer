...
public class UserSentAdapter extends RecyclerView.Adapter<UserSentAdapter.SentUserViewHolder>{
    ...
    @NonNull
    @Override
    public UserSentAdapter.SentUserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        UserSentAdapter.SentUserViewHolder cvh = new UserSentAdapter.SentUserViewHolder(view);
        return cvh;
    }

    @Override
    public void onBindViewHolder(@NonNull UserSentAdapter.SentUserViewHolder holder, int position) {
