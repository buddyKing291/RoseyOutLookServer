...
public class UserRequestAdapter extends RecyclerView.Adapter<UserRequestAdapter.RequestUserViewHolder>{
    ...
    @NonNull
    @Override
    public UserRequestAdapter.RequestUserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        UserRequestAdapter.RequestUserViewHolder cvh = new UserRequestAdapter.RequestUserViewHolder(view);
        return cvh;
    }

    @Override
    public void onBindViewHolder(@NonNull UserRequestAdapter.RequestUserViewHolder holder, int position) {
