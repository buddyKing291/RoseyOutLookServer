...
public class User {
    ...
    public User(String name, String username, UserType type, Blob profilePic){
        this.name = name;
        this.username = username;
        this.type = type;
    ...
    public User(String name, String username,UserRelationship relation, Blob profilePic){
        this.name = name;
        this.username = username;
        this.relation = relation;
        this.profilePic = profilePic;
